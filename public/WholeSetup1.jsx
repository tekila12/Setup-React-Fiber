...
export function Model(props) {
  ...
  function handleClick(event) {
    ...
    const materials = intersects.object;
  
    // modify the mesh's material
    if (materials.name === 'Power_Up') {
     actions.Spin2.play()
     actions.Spin1.play()
     actions.Spin.play()
     actions.Spin3.play()
        ...
        <group name="Sketchfab_model002" position={[0, 4.23, 0]} rotation={[-Math.PI / 2, 0, -1.56]}>
          <group name="dd12f1d0399348aab05d4e554860e7c0fbx" rotation={[Math.PI / 2, 0, 0]} scale={0.01}>
            <group name="RootNode001">
              ...
              <group name="BezierCircle" position={[87.65, 308.19, -282.27]} rotation={[-Math.PI / 2, 1.57, 0]} scale={5.7}>
