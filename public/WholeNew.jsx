...
Command: npx gltfjsx@6.1.3 wholeNew.glb
*/
...
export function Model(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/wholeNew.glb')
        ...
        <group name="Sketchfab_model002" position={[0, 4.23, 0]} rotation={[-Math.PI / 2, 0, -1.56]}>
          <group name="dd12f1d0399348aab05d4e554860e7c0fbx" rotation={[Math.PI / 2, 0, 0]} scale={0.01}>
            <group name="RootNode001">
              <group name="aorus_case_fans" position={[89.59, 288.68, -355.42]} rotation={[0, 1.57, 0]} scale={108.52} />
              <group name="aorus_case_fans001" position={[69.02, 288.68, -355.42]} rotation={[0, -1.57, 0]} scale={108.52} />
              <group name="aorus_case_fans002" position={[89.59, 178.11, -355.42]} rotation={[0, 1.57, 0]} scale={108.52} />
              <group name="aorus_case_fans003" position={[69.02, 178.11, -355.42]} rotation={[0, -1.57, 0]} scale={108.52} />
              <group name="aorus_case_fans004" position={[-241.08, 292.6, -334.76]} rotation={[0, 1.57, 0]} scale={108.52} />
              <group name="aorus_case_fans005" position={[-261.65, 292.6, -334.76]} rotation={[0, -1.57, 0]} scale={108.52} />
              ...
              <group name="BezierCircle" onClick={handleClick} position={[87.65, 308.19, -282.27]} rotation={[-Math.PI / 2, Math.PI / 2, 0]} scale={5.7}>
              ...
              <group name="Cube001" position={[-61.02, -0.56, 156.09]} rotation={[Math.PI / 2, 0, -Math.PI]} scale={[-368.95, -731.64, -25.98]} />
              <group name="Cube001_1" position={[-138.59, 295.65, 300.41]} rotation={[-Math.PI / 2, -0.07, Math.PI / 2]} scale={[325.34, 4.05, 184.09]}>
              ...
              <group name="Text001" position={[87.59, 202.48, -275.49]} rotation={[-Math.PI / 2, Math.PI / 2, 0]} scale={[10.33, 8.38, 9.72]}>
