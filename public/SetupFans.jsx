...
Command: npx gltfjsx@6.1.2 SetupFans.glb
*/
...
export function Model(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/SetupFans.glb')
          ...
          <group name="dd12f1d0399348aab05d4e554860e7c0fbx" rotation={[Math.PI / 2, 0, 0]} scale={0.01}>
            <group name="RootNode001">
              ...
              <group name="BezierCircle" position={[87.65, 308.19, -282.27]} rotation={[-Math.PI / 2, 1.57, 0]} scale={5.7}>
                <mesh name="Power_Up" geometry={nodes.Power_Up.geometry} material={materials['PowerUp.001']} />
              </group>
