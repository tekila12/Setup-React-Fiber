...
Command: npx gltfjsx@6.1.3 veryNewSetup123.glb
*/
...
export function Setup(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/veryNewSetup123.glb')
...
const handlekeyboard  = () => {
  intervalId = setInterval(() => {
    const material074_30 = materials["Material.055"];
        ...
        <group name="Sketchfab_model002" position={[0, 4.23, 0]} rotation={[-Math.PI / 2, 0, -1.56]}>
          <group name="dd12f1d0399348aab05d4e554860e7c0fbx" rotation={[Math.PI / 2, 0, 0]} scale={0.01}>
            <group name="RootNode001">
              ...
              <group name="Plane_1" position={[117.18, 25.6, -29.17]} rotation={[-Math.PI / 2, 0, 0]} scale={[124.43, 154.11, 119.91]}>
...
useGLTF.preload('/veryNewSetup123.glb')
