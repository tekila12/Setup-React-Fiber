  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        ...
        <mesh name="MY_SCREEN_MY_SCREEN_0" onClick={Push} geometry={nodes.MY_SCREEN_MY_SCREEN_0.geometry}material={new THREE.MeshStandardMaterial({ map: new THREE.TextureLoader().load(images[currentImageIndex]) })} position={[-5.72, 7.3, 0.99]} scale={3.67} />
